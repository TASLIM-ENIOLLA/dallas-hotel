					...
					<div className="flex flex-row-reverse gap-10">
						<div className="md:w-7/12">
							<div className="space-y-10">
								<div className="text-2xl md:text-4xl leading-normal font-bold">
									Leave a message
								</div>
								<div className="grid grid-cols-2 gap-10">
									<div className="col-span-1">
										<div className="space-y-3">
											...
											<input name="name" className="p-4 border border-gray-300 block w-full" />
										</div>
									</div>
									<div className="col-span-1">
										<div className="space-y-3">
											<div className="text-lg capitalize font-medium">email address</div>
											<input name="email" className="p-4 border border-gray-300 block w-full" />
										</div>
									</div>
					...
					<div className="flex flex-wrap justify-center gap-10 pt-20">
						...
						<div className="md:w-1/4">
							<div className="text-center space-y-3">
								...
								<Link href="mailto://info@dallasgrandbeachhotel.com" className="capitalize underline block w-full text-lg font-normal">
